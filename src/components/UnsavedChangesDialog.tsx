...
export function UnsavedChangesDialog({
  ...
  const footer = (
    <div className="flex gap-3 w-full justify-end">
      ...
      <Button variant="emerald" size="md" onClick={handleSave}>
        Save to Drafts
      </Button>
    </div>
  );
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Unsaved Changes" footer={footer}>
      <div className="space-y-4">
        <p className="text-gray-300">
          ...
          <span className="font-semibold text-white">&quot;{patternName}&quot;</span>.
        </p>
        ...
        <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
          <h4 className="text-sm font-medium text-gray-300 mb-2">Your options:</h4>
          <ul className="text-sm text-gray-400 space-y-1">
            <li className="flex items-start gap-2">
              <span className="text-emerald-400">Save to Drafts</span>
